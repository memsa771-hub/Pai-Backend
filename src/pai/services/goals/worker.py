...
from pai.services.jobs.lease import MAX_ATTEMPTS, apply_failure
...
async def process_goal_job(
    ...
    from pai.services.goals.pipeline import run_full_pipeline, run_assessment_stage, run_gaps_stage, run_planning_stage, build_counselor_brief
    ...
    if kind == "assessment_refresh" and intel is not None and intel.research:
        ...
        from pai.services.goals.pipeline import run_assessment_stage, run_gaps_stage, run_planning_stage, build_counselor_brief
