...
from pai.services.memory.postgres_store import AsyncPostgresMemoryStore, InProcessMemoryStore
...
class PersonMemoryService:
    ...
    by pai.services.memory.formation — not dumped as one blob per turn.
