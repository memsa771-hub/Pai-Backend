...
from pai.services.vault.catalog import CATALOG_VERSION, GUIDANCE_SCOPES, CatalogField, get_catalog_field
from pai.services.vault.completion import apply_completion_to_vault
from pai.services.vault.security import SensitiveValueCodec, mask_value
...
class VaultService:
    ...
    async def get_unified_vault(
        ...
        *,
        ...
        from pai.services.vault.completion import compute_completion, compute_completion_from_snapshot
        ...
        if typed_records is not None:
            ...
            from pai.services.vault.completion import load_presence_snapshot
