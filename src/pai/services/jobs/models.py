...
class PersonJob(Base):
    """Durable per-student work. Postgres is the queue until Temporal is worth running."""
    ...
    kind: Mapped[str] = mapped_column(String(64), default="chat_intelligence", nullable=False)
