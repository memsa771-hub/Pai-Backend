...
from pai.kernel.contracts.memory import MemoryObservation as MemoryDraft
...
def __getattr__(name):
    # Compatibility only. Production callers use the workflow adapter directly.
    if name in {"drafts_from_turn", "memory_key_for", "importance_of"}:
        from pai.workflows.student_learning import memory
